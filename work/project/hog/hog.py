...
def play(strategy0, strategy1, update,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    # simple_update(num_rolls, player_score, opponent_score, dice=six_sided)
    player_turns = False
    while score0 < goal and score1 < goal:
        if not player_turns:  # player0
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    max_point, max_dice = 1, 1
    for i in range(1, 11):
        temp = averaged_dice(i, dice)
        if temp > max_point:
            max_point, max_dice = temp, i
    return max_dice
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if fuzzy_update(0, score, opponent_score) - score >= make_averaged(roll_dice,100)(6):
        return 0
    else:
        return 6
    # END PROBLEM 12
